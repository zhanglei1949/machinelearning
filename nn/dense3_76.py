...
def train_and_evaluate(filename, model_name,batch_size = 320,epochs = 6):
    ...
    #model.add(Dense(1240,activation = 'relu',kernel_regularizer=regularizers.l2(0.01)))
    #model.add(Dropout(0.2))
...
def main():
    filename = '../EEG.mat'
    train_and_evaluate(filename =filename, model_name = '6_12_1.h5', epochs = 12,batch_size =140 )
