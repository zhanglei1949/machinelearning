function [TrainingTime,  TrainingAccuracy, TestingAccuracy,label_index_actual,label_index_expected] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    clear label_index_expected
    clear label_index_actual
    for i = 1 : size(TV.T, 2)
